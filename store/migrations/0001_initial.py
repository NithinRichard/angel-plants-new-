# Generated by Django 5.0.3 on 2025-05-28 11:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razorpay_order_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='razorpay order id')),
                ('payment_signature', models.CharField(blank=True, max_length=200, null=True, verbose_name='payment signature')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='notes')),
                ('cart', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order', to='store.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='profile_pictures/default-avatar.png', upload_to='profile_pictures/', verbose_name='profile picture')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['order'], name='store_order_order_i_70b6d9_idx'), models.Index(fields=['product'], name='store_order_product_056298_idx')],
            },
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1)], verbose_name='quantity')),
                ('price', models.DecimalField(decimal_places=2, help_text='Price at time of adding to cart', max_digits=10, verbose_name='price')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
